...
const VaultI18n = {
  ...
  strings: {
    el: {
      ...
      deleteNote: "Διαγραφή",
      graphOverview: "Επισκόπηση vault",
      graphIndex: "Χάρτης index (μόνο θεματικές)",
      graphAuto: "Αυτόματα (τρέχουσα σημείωση)",
      graphFocus: "Εστίαση στην επιλογή",
      graphFocusLabel: "εστίαση",
      graphTheme: "Θεματική τώρα",
      graphSubtopic: "Υποθέμα τώρα",
      graphFull: "Πλήρης vault (βαρύ)",
    ...
    en: {
      ...
      editNote: "Edit",
      deleteNote: "Delete",
      graphOverview: "Vault overview",
      graphIndex: "Index map (themes only)",
      graphAuto: "Auto (current note)",
      graphFocus: "Focus on selection",
      graphFocusLabel: "focus",
      graphTheme: "Current theme",
      graphSubtopic: "Current subtopic",
      graphFull: "Full vault (heavy)",
